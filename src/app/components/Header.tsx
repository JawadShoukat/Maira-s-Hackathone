    ...
    <div>
      ...
      <div className="w-full h-[36px] bg-primaryColor flex justify-between items-center px-6 py-2 text-[10px] font-medium text-gray-500">
        ...
        <div className="flex gap-4  ">
          <Link href="/" className="hover:text-gray-800  link-separator">Home</Link>
          <Link href="/signUp" className="hover:text-gray-800  link-separator">Sign Up</Link>
          <Link href="/log-in" className="hover:text-gray-800 link-separator">Log In</Link>
          <Link href="/join-us" className="hover:text-gray-800 link-separator">Join Us</Link>
          <Link href="/help" className="hover:text-gray-800 link-separator">Help</Link>
          <Link href="/store" className="hover:text-gray-800 link-separator">Store</Link>
          <Link href="/stan" className="hover:text-gray-800 link-separator">Stan</Link>
        </div>
      </div>
